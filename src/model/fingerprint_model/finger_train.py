...
import argparse
import numpy as np
from src.model.fingerprint_model.finger_model import Finger_Model,finger_class
...
def parse_opt():
    ...
    parser.add_argument("--save-dir",type=str,default="D:/social/QQ/files/1448931856/FileRecv/sapas_app_back/src/model/fingerprint_model/models/fingermodel/",help="save models dir")#保存模型路径
