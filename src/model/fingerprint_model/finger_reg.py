...
from src.model.fingerprint_model import filter
...
def finger_reg_main(raw_wav,user_phone):
    ...
    pic_dir="D:/social/QQ/files/1448931856/FileRecv/sapas_app_back/src/model/fingerprint_model/models/pic/"+user_phone+"/train/"+str(tim_now)+"/"
    os.makedirs(pic_dir,exist_ok=True)
    pic_val_dir="D:/social/QQ/files/1448931856/FileRecv/sapas_app_back/src/model/fingerprint_model/models/pic/"+user_phone+"/val/"+str(tim_now)+"/"
